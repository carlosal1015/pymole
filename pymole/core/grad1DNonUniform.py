...
def grad1DNonUniform(k, ticks, dx=1.0):
...
if __name__ == "__main__":
    print(grad1DNonUniform(2, np.array([0, 0.1, 0.15, 0.2, 0.3, 0.4, 0.45]), 1))
    print(
        grad1DNonUniform(
            4, np.array([0, 0.1, 0.15, 0.2, 0.3, 0.4, 0.45, 0.5, 0.6, 0.65]), 1
        )
    )
